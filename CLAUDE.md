...
#### Vertical Bars
The empty bar is transparent, so the car interior can show through and move as the camera pitches. Only color anchored at the bottom of the ROI is the pedal.

1. A row counts when most of its width is the bar color
2. Walk up from the bottom
3. Stop at a gap larger than a couple of pixels
4. Convert that height to a percentage
